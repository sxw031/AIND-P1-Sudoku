...
def cross(a, b):
    """
    given two strings, return the list formed by all the possible concatenation of a letter s in string a with a letter t in string b.
...
def naked_twins(values):
    ...
    naked_twins =[[box1, box2] for box1 in pairs for box2 in peers[box1] if set(values[box1]) == set(values[box2])]
...
def reduce_puzzle(values):
    ...
    stalled = False
    while not stalled:
        # check how many boxed have a determined value
        ...
        # check how many boxex have a determined value, to compare 
...
def search(values):
    """Using depth-first search and propagation, create a search tree and solve the sukoku."""
